...
for year_val in val_list:
    for Strategy_type in ['Strategy 2', 'Strategy 3']:
        ...
        net_profit_strat1_chiose2_merge = ev_battery_type_selected_chios[colums[:2]].merge(
            ...
            on=['country', 'type'],
            how='left')
        net_profit_strat1_chiose2_merge.fillna(0, inplace=True)
        net_profit_strat1_chiose2_merge.to_csv(f'./trans/result/{year_val}/net_profit_{recycl_op}_{Strategy_type}.csv',
                                               index=True)
        net_profit_strat.to_csv(f'./trans/result/{year_val}/net_profit_all_{Strategy_type}.csv', index=True)

        net_profit_strat1_chiose2['total_netprofits'] = net_profit_strat1_chiose2['scrap_sum'] * \
        ...
        net_profit_strat_chiose = net_profit_strat.loc[
            idx, ['country', 'type', 'recycling_m', 'scrap_sum', 'unit_cost']]

        net_profit_strat_chiose['total_costs'] = net_profit_strat_chiose['scrap_sum'] * net_profit_strat_chiose[
            'unit_cost'] * 1000
        ...
        cost_strat_country['unit_cost'] = cost_strat_country['total_costs'] / \
                                          cost_strat_country['scrap_sum'] / 1000
        cost_strat_country.to_csv(f'./trans/result/{year_val}/country_cost_{recycl_op}_{Strategy_type}.csv', index=True)

        disposal_mass_diff_stra_df = disposal_mass_diff_stra_df.append(
            net_profit_strat1_chiose2[['country', 'type', 'recycling_m', 'scrap_sum']])
        ...
        net_profit_strat_country.to_csv(
            f'./trans/result/{year_val}/country_net_profit_{recycl_op}_{Strategy_type}.csv', index=True)
    ...
    net_profit_strat1_chiose1, net_profit_strat1 = fun_class.OUTPUTNetProfitofOptimalOne(ev_battery_type_selected,
                                                                                         ...
                                                                                         dist_cost)
    net_profit_strat1_chiose1.iloc[:, [0, 1, 2, 4]].to_csv(f'./trans/result/{year_val}/net_profit_{recycl_op}_Strategy 1.csv', index=True)
    net_profit_strat1.to_csv(f'./trans/result/{year_val}/net_profit_all_Strategy 1.csv', index=True)

    net_profit_strat1_chiose1['total_netprofits'] = net_profit_strat1_chiose1['scrap_sum'] * net_profit_strat1_chiose1[
        'net_profit'] * 1000
    ...
    disposal_mass_diff_stra_df = disposal_mass_diff_stra_df.append(
        net_profit_strat1_chiose1[['country', 'type', 'recycling_m', 'scrap_sum']])
    disposal_mass_diff_stra_df['year'] = [year_val] * len(disposal_mass_diff_stra_df)
    ...
    cost_strat_country.to_csv(f'./trans/result/{year_val}/country_cost_{recycl_op}_Strategy 1.csv', index=True)
    net_profit_strat_country.to_csv(f'./trans/result/{year_val}/country_net_profit_{recycl_op}_Strategy 1.csv', index=True)
    disposal_mass_diff_stra_df1 = disposal_mass_diff_stra_df1.append(disposal_mass_diff_stra_df)
...
disposal_mass_diff_stra_df1.to_csv(f'./trans/result/country_disposal_mass_diff_stra_{recycl_op}.csv', index=True)
CO2_em_df.to_csv(f'./trans/result/CO2_em_trans_{recycl_op}.csv', index=True)
CO2_em_disposal_mass_diff_stra.to_csv(f'./trans/result/CO2_em_disposal_mass_diff_stra_{recycl_op}.csv', index=True)
